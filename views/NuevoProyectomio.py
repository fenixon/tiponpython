...
class Ui_frmNuevoProyecto(object):
    ...
    def cambioMetodo(self,nombreMetodo):
        if nombreMetodo != '':
            ...
            print "cantidad de parametros ",len(controlador.metodo.listaParametros)

            print "parametros c",str(controlador.metodo.listaParametros[len(controlador.metodo.listaParametros)-1].nombre)


            print "lista paraemtros", controlador.metodo.listaParametros

            ventana.resize(405, 616)
            self.gbParametrosDominio.setGeometry(QtCore.QRect(30, 430 , 351, 181))
            self.btnNuevo.setGeometry(QtCore.QRect(230, 580 , 99, 23))
            ...
            for n in range(0,len(controlador.metodo.listaParametros)):
                ...
                botonY = botonY + 40
                #ventana.resize(405, ventanaY)
                #self.gbParametrosDominio.setGeometry(QtCore.QRect(30, 430 , 351, groupboxY+300))
